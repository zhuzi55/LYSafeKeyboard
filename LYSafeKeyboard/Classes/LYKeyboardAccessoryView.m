...
@interface LYKeyboardAccessoryView()
...
@implementation LYKeyboardAccessoryView
...
-(UIButton *)finishBtn{
    if (!_finishBtn) {
        ...
        UIImage *image = [LYKeyboardTool getImageWithResouce:@"doneIcon@3x.png"];
